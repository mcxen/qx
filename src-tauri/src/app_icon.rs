...
mod tests {
    ...
    #[test]
    fn unknown_icon_ids_fall_back_to_original() {
        assert_eq!(normalize_id("future-or-corrupt-value"), ORIGINAL_ICON_ID);
        assert_eq!(icon_bytes("future-or-corrupt-value"), ORIGINAL_ICON_PNG);
    }
}
