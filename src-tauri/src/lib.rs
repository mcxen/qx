...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            screencap::selection::screencap_set_picker_interaction_lock,
            ...
            plugin_api::plugin_ai_stream_chat_events,
            ...
            plugin_system::plugin_system_save_download,
            ...
            qx_ai_sessions::qxai_sessions_index,
            ...
            qx_ai_memory::qxai_memory_clear,
            ...
            ocr::ocr_recognize_clipboard_image,
            ocr::ocr_list_history,
            ocr::ocr_delete_history,
            ocr::ocr_clear_history,
            ocr::ocr_copy_result_text,
            ocr::ocr_status,
            ocr::clipboard_ocr_pending,
            ...
            g4f::qxai_stream_chat_with_tools_events,
