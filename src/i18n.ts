...
const zh: Record<string, string> = {
  ...
  "screencap.fullSelectHint": "录制鼠标所在显示器全屏 · 内置屏和外接屏均可区域圈选",
  ...
  "screencap.picker.screenshot": "在 {display} 上拖动圈选，松手截图 · Esc 取消",
  "screencap.picker.recording": "在 {display} 上拖动圈选，松手开始录制 · Esc 取消",
