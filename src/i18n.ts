...
const zh: Record<string, string> = {
  ...
  "screencap.fullSelectHint": "录制整个主屏幕 · 选择区域会展开到桌面以进行真实区域选择",
  "screencap.tips": "提示",
  ...
  "screencap.select.drag": "在主屏幕上拖动选择 · Esc 取消",
  "screencap.select.primary": "拖动选择主屏幕区域 · Esc 取消",
  "screencap.select.fallback": "拖动选择（窗口内回退模式）· Esc 取消",
