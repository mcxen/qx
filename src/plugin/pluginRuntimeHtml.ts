...
import type { PluginModuleGraph } from "./moduleGraph";

/** Snapshot of plugin display prefs for iframe bootstrap (also used by loadPlugin). */
export function pluginDisplaySettingsSnapshot(): PluginDisplaySettings {
  return {
