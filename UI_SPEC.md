...
- 键盘：Enter 确认、双击选区确认、**⌘C / Ctrl+C 立即截图并复制到剪贴板，跳过延迟并隐藏圈选层与 Qx 主界面**（标注文本框内保留原生复制）、Space 全屏、S/V 切换截图/录屏、R 上次选区、Tab 区域/全屏、1–6 工具、⌘Z/⇧⌘Z 撤销重做、Esc 分层退出。上次成功选区仅在“记住上次选区”开启时作为默认精修起点。
